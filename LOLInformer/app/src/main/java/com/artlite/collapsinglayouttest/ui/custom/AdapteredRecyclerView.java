package com.artlite.collapsinglayouttest.ui.custom;
...
public class AdapteredRecyclerView<T extends AdapteredRecyclerView.BaseObject> extends RecyclerView {
    ...
    public static class BaseApplicationRecyclerAdapter<T extends BaseObject> extends RecyclerView.Adapter<BaseApplicationRecyclerAdapter.ViewHolder> {
    ...
    public static abstract class BaseRecyclerItem<T extends AdapteredRecyclerView.BaseObject> extends BaseView {
